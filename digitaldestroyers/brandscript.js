...
function display(){
    ...
    var r = p.toUpperCase()+' | Health and Beauty';
    document.title = r;
}
...
function sendRequest(url){
    ...
    xmlhttp.onreadystatechange = function(){
        if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
            ...
            let brand = document.getElementById('product-des');
            var s = 0;
            ...
            for(let i=0;i<data.length;i++){
                ...
                if(data[i].product_colors.length !== 0){
                    ...
                    y += '<div class="prod-des"><div class="image"><img src="'+makeup.image+'"><div id="color">'+z+'</div></div>'+'<div class="info"><h4>'+makeup.name+'</h4></div><div class="price"><strong>$'+makeup.price+'</strong></div></div>';  
            }    
            brand.innerHTML = y;
